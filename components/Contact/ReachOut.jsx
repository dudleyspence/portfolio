    ...
    <div className="flex w-full flex-col justify-center items-center mt-10">
      <div className="flex flex-col gap-5 w-[280px]">
        ...
        >
          <svg
            id="linkedinIcon"
            className="fill-inherit h-7 w-7 cursor-pointer"
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
          >
            <g>
