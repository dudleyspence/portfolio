...
export default function AboutMe({ t }) {
  return (
    <div className="flex w-full flex-col-reverse xl:flex-row-reverse bg-background relative justify-center items-center">
      <div className=" relative w-full xl:w-2/5 shrink-0 overflow-hidden">
        <MapImage />
      </div>
      <div className="font-sans xl:w-3/5 xl:pr-6 pb-6 xl:pt-0">
