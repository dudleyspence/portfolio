...
export default function ThisPortfolio({ t }) {
  return (
    <div>
        ...
        <div className="w-full md:w-1/2 xl:w-2/3">
          <div className="flex flex-row items-start gap-2 mb-5 ">
            ...
            <div className="flex flex-row gap-2 flex-wrap">
              {["Next.js", "next-intl", "TailwindCSS"].map((skill) => (
                <p
                  key={skill}
          ...
          <p className="w-full font-sans font-medium mb-5 text-text">
            {t("this_portfolio_desc_1")}
          </p>
          <p className="w-full font-sans font-medium text-text">
            {t("this_portfolio_desc_2")}
          </p>
        </div>
