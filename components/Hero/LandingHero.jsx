...
export default function LandingHero({ t }) {
  return (
    <div className="flex flex-col lg:flex-row gap-7 lg:gap-15 xl:gap-20 mt-5 md:mt-0 justify-start md:justify-center items-center h-[calc(100vh-60px)] lg:h-[calc(100vh-108px)]">
      <ProfileImage />
